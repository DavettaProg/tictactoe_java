...
public class tictactoe extends javax.swing.JFrame {
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        menuItemJugadorVsMaquinaActionPerformed(evt);
    }//GEN-LAST:event_jMenuItem1ActionPerformed
     
    public void menuItemJugadorVsMaquinaActionPerformed(java.awt.event.ActionEvent evt) {    
        tictactoemaquina tictactoemaquina = new tictactoemaquina();
        tictactoemaquina.setVisible(true);
     this.dispose();
}
